...
def add_data_options(parser):
    ...
    parser.add_argument('-train_guide_src')
    parser.add_argument('-guide_src_vocab')
    ...
    # Test options
    parser.add_argument('-dev_input_src', help='Path to the dev input file.')
    parser.add_argument('-dev_guide_src', help='Path to the dev input file.')
    parser.add_argument('-dev_ref', help='Path to the dev reference file.')
